...
public class PrimaryKeyGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        /**
         * Ghenoie New - 04-02-2011: Extending BASEVO from the PrimaryKeyGenerator in case the Table
         * has only many columns as Primary key (meaning it generates a PrimaryKey Class)
         */
        else
        {
	        FullyQualifiedJavaType superClass = new FullyQualifiedJavaType("com.path.lib.vo.BaseVO");
	        if (superClass != null) {
