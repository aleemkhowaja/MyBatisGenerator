...
public class ResultMapWithBLOBsElementGenerator extends
    ...
    private void addResultMapElements(XmlElement answer) {
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            String columnName = MyBatis3FormattingUtilities.getRenamedColumnNameForResultMap(introspectedColumn);
           
            // Donot Add Fields Related to Integration into VO
            if("ORIGIN_BR_I".equalsIgnoreCase(columnName)
               || "ORIGIN_BR_U".equalsIgnoreCase(columnName)
               || "ORIGIN_BR_D".equalsIgnoreCase(columnName))
            {
        	continue;
            }
            ...
            /**
             * Ghenoie MEC - 03-02-2011: Remove the jdbcType from the resultMap
             */
//            resultElement.addAttribute(new Attribute(
