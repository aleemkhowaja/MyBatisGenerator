...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        /**
         * Ghenoie MEC - 02-02-2011 : Instead of Static ByExample ids,
         *  we use the insert/delete/select/update + tableName  for the id of the xml mapper
         */
...
//        setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause"); //$NON-NLS-1$
        ...
        /**
         * Ghenoie New - 02-02-2011 : Instead of ByExample,
         *  we use the insert/delete/select/update + tableName  for the id of the xml mapper
         */ 
        setCountByExampleStatementId("count".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setDeleteByExampleStatementId("delete".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId("delete".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setInsertStatementId("insert".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setInsertSelectiveStatementId("insert".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setSelectByExampleStatementId("select".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("select".concat(tableConfiguration.getTableName()).concat("WithBLOBs")); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("select".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setUpdateByExampleStatementId("update".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId("update".concat(tableConfiguration.getTableName()).concat("Selective")); //$NON-NLS-1$
        setUpdateByExampleWithBLOBsStatementId("update".concat(tableConfiguration.getTableName()).concat("WithBLOBs")); //$NON-NLS-1$
        setUpdateByPrimaryKeyStatementId("update".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId("update".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateWithBLOBs".concat(tableConfiguration.getTableName())); //$NON-NLS-1$
        setBaseResultMapId("BaseResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId( tableConfiguration.getTableName().concat("_Where_Clause")); //$NON-NLS-1$
        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_".concat(tableConfiguration.getTableName()).concat("Where_Clause")); //$NON-NLS-1$
